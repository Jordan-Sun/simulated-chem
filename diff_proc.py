...
Algorithms for the dynamic constrained reassignment problem:
    ...
    - The number of processors that columns can be send to is constrained to 1.
    - The number of processors that columns can be received from is constrained to 1 (albeit may be different from the send processor).
"""
...
if __name__ == "__main__":
    ...
    assignment = reassign(workload, original_assignment, 0, 1, f"test/MIQCP/c{res}_p{procs}/solution.txt", 10000.0)
